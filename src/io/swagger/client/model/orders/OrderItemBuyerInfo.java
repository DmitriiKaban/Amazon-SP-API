...
import io.swagger.client.model.orders.BuyerCustomizedInfoDetail;
...
public class OrderItemBuyerInfo {
  ...
  **/
  ...
  public OrderItemBuyerInfo buyerCustomizedInfo(BuyerCustomizedInfoDetail buyerCustomizedInfo) {
   ...
   /**
   * Buyer information for custom orders from the Amazon Custom program.  **Note**: This attribute is only available for MFN (Fulfilled by the seller) orders.
   * @return buyerCustomizedInfo
  **/
  @ApiModelProperty(value = "Buyer information for custom orders from the Amazon Custom program.  **Note**: This attribute is only available for MFN (Fulfilled by the seller) orders.")
  ...
  **/
  @ApiModelProperty(value = "A gift message provided by the buyer.  **Note**: This attribute is only available for MFN (Fulfilled by the seller) orders.")
