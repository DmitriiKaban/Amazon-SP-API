...
import io.swagger.client.model.orders.Address;
import io.swagger.client.model.orders.AutomatedShippingSettings;
import io.swagger.client.model.orders.BuyerInfo;
import io.swagger.client.model.orders.BuyerTaxInformation;
import io.swagger.client.model.orders.EasyShipShipmentStatus;
import io.swagger.client.model.orders.ElectronicInvoiceStatus;
import io.swagger.client.model.orders.FulfillmentInstruction;
import io.swagger.client.model.orders.MarketplaceTaxInfo;
import io.swagger.client.model.orders.Money;
import io.swagger.client.model.orders.PaymentExecutionDetailItemList;
import io.swagger.client.model.orders.PaymentMethodDetailItemList;
...
public class Order {
  ...
  **/
  @ApiModelProperty(value = "When true, the estimated ship date is specified for the order. Returned only for Sourcing on Demand orders.")
  ...
  **/
  ...
  public Order buyerTaxInformation(BuyerTaxInformation buyerTaxInformation) {
   ...
   /**
   * Contains the business invoice tax information. Sellers can use this data to issue electronic invoices for business orders in Turkey.  **Note**: 1. This attribute is only available in the Turkey marketplace for the orders that &#x60;BuyerInvoicePreference&#x60; is BUSINESS. 2. The &#x60;BuyerTaxInformation&#x60; is a restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access this restricted data.
   * @return buyerTaxInformation
  **/
  @ApiModelProperty(value = "Contains the business invoice tax information. Sellers can use this data to issue electronic invoices for business orders in Turkey.  **Note**: 1. This attribute is only available in the Turkey marketplace for the orders that `BuyerInvoicePreference` is BUSINESS. 2. The `BuyerTaxInformation` is a restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access this restricted data.")
  ...
  **/
  ...
  public Order buyerInfo(BuyerInfo buyerInfo) {
   ...
   /**
   * Buyer information.  **Note**: The &#x60;BuyerInfo&#x60; contains restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access the restricted data in &#x60;BuyerInfo&#x60;, for example, &#x60;BuyerName&#x60;, &#x60;BuyerTaxInfo&#x60;, &#x60;PurchaseOrderNumber&#x60;.
   * @return buyerInfo
  **/
  @ApiModelProperty(value = "Buyer information.  **Note**: The `BuyerInfo` contains restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access the restricted data in `BuyerInfo`, for example, `BuyerName`, `BuyerTaxInfo`, `PurchaseOrderNumber`.")
