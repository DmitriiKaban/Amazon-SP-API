...
import io.swagger.client.model.orders.AddressExtendedFields;
...
public class Address {
  ...
  **/
   ...
   * @return phone
  **/
  @ApiModelProperty(value = "The phone number of the buyer.  **Note**:  1. This attribute is only available for shipping address. 2. The buyer `Phone` number is suppressed in some cases, including but not limited to  a. `Phone` is suppressed for all Fulfillment by Amazon (FBA) orders. b. `Phone` is suppressed for the shipped MFN(Fulfilled by the seller) order when current date is past Latest Delivery Date.")
  ...
  public Address extendedFields(AddressExtendedFields extendedFields) {
   ...
   /**
   * The container for address extended fields. For example, street name or street number.  Note: Only available for Brazil shipping addresses.
   * @return extendedFields
  **/
  @ApiModelProperty(value = "The container for address extended fields. For example, street name or street number.  Note: Only available for Brazil shipping addresses.")
