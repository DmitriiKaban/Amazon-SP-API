...
import io.swagger.client.model.orders.AssociatedItem;
import io.swagger.client.model.orders.BuyerRequestedCancel;
import io.swagger.client.model.orders.ItemBuyerInfo;
import io.swagger.client.model.orders.Measurement;
import io.swagger.client.model.orders.Money;
import io.swagger.client.model.orders.PointsGrantedDetail;
import io.swagger.client.model.orders.ProductInfoDetail;
import io.swagger.client.model.orders.PromotionIdList;
import io.swagger.client.model.orders.ShippingConstraints;
import io.swagger.client.model.orders.SubstitutionPreferences;
import io.swagger.client.model.orders.TaxCollection;
...
public class OrderItem {
  ...
  **/
   ...
   * @return itemPrice
  **/
  @ApiModelProperty(value = "The selling price of the order item. An order item is an item and a quantity. This means that the value of `ItemPrice` is equal to the selling price of the item multiplied by the quantity ordered. Note that `ItemPrice` excludes `ShippingPrice` and `GiftWrapPrice`.")
  ...
  **/
   ...
   * @return isGift
  **/
  @ApiModelProperty(value = "Indicates whether the item is a gift.  **Possible values**: `true`, `false`.")
  ...
  **/
  ...
  public OrderItem buyerInfo(ItemBuyerInfo buyerInfo) {
   ...
   /**
   * A single item&#39;s buyer information.  **Note**: The &#x60;BuyerInfo&#x60; contains restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access the restricted data in &#x60;BuyerInfo&#x60;, for example, &#x60;BuyerCustomizedInfo&#x60; and &#x60;GiftMessageText&#x60;.
   * @return buyerInfo
  **/
  @ApiModelProperty(value = "A single item's buyer information.  **Note**: The `BuyerInfo` contains restricted data. Use a Restricted Data Token (RDT) and restricted Selling Partner API roles to access the restricted data in `BuyerInfo`, for example, `BuyerCustomizedInfo` and `GiftMessageText`.")
