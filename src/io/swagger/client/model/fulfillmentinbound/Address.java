...
public class Address {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the individual or business.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressLine1, addressLine2, city, companyName, countryCode, name, postalCode, stateOrProvinceCode);
  }
