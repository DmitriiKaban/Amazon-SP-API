...
public class PrepInstruction {
  ...
  **/
   ...
   * @return prepOwner
  **/
  @ApiModelProperty(value = "In some situations, special preparations are required for items and this field reflects the owner of the         preparations. Options include `AMAZON` or `SELLER`.")
